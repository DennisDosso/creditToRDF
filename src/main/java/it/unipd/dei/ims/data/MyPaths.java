...
public class MyPaths {
	...
	public static String index_path = "/Users/anonymous/MEGAsync/Ricerca/progetti_di_ricerca/CreditToRDF/bsbm100k";

	public static String reduced_index_path = "/Users/anonymous/MEGAsync/Ricerca/progetti_di_ricerca/CreditToRDF/bsbm100kreduced";

	/** path of the file with the values for the query*/
	public static String values_path = "/Users/anonymous/MEGAsync/Ricerca/progetti_di_ricerca/CreditToRDF/random values for queries/1/random_values_for_query_1.csv";


	/** the times file described how many times each query is executed
	 * */
	public static String times_file_path = "/Users/anonymous/MEGAsync/Ricerca/progetti_di_ricerca/CreditToRDF/random values for queries/1/times_uniform.txt";
	public static String times_file_path_normal_distribution = "/Users/anonymous/MEGAsync/Ricerca/progetti_di_ricerca/CreditToRDF/random values for queries/1/times_normal.txt";

	/** Path for an index that you are querying
	 * */
	public static String querying_index = "/Users/anonymous/MEGAsync/Ricerca/progetti_di_ricerca/CreditToRDF/bsbm100k";
